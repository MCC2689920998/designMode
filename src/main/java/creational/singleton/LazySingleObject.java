...
public class LazySingleObject {
     ...
     * @return
     */
    public static LazySingleObject getInstance1() {
        if (instance == null) {
     ...
     * @return
     */
    public static synchronized LazySingleObject getInstance2() {
        if (instance == null) {
            instance = new LazySingleObject();
        }
        return instance;
     ...
     * @return
     */
    public static LazySingleObject getInstance4() {
        if (instance == null) {
     ...
     * {@link HungrySingleObject#getInstance3()}
     * 而这种方式是 Singleton 类被装载了，instance 不一定被初始化。因为 SingletonHolder 类没有被主动使用，
     * 只有通过显式调用 getInstance4 方法时，才会显式装载 SingletonHolder 类，从而实例化 instance。
    ...
    private static class SingletonHolder {
        private static final LazySingleObject INSTANCE = new LazySingleObject();
    }

    public static final LazySingleObject getInstance5() {
