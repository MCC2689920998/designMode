...
**如何解决**：拦截的类都实现统一接口。    
**关键代码**：
1. Handler 里面聚合它自己，在 HandlerRequest 里判断是否合适，如果没达到条件则向下传递，向谁传递之前 set 进去。 
...
**注意事项**：
1. 在 JAVA WEB 中遇到很多应用

#### 具体实现
![avatar](https://www.runoob.com/wp-content/uploads/2014/08/chain_pattern_uml_diagram.jpg)
